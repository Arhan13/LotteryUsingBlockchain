...
const provider = new HDWalletProvider(
	...
	'rinkeby.infura.io/v3/90a0be42f7634d90a6b0318e23e1cb07'
...
const deploy = async()=>{
	...
	console.log('Attempting to deploy from account',acconts[0]);
	...
	.deploy({data:bytecode,arguments:['Hi there!']})//Will contain the byte code and any initial statements
